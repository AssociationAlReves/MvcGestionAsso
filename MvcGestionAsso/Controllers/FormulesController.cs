...
namespace MvcGestionAsso.Controllers
{
    public class FormulesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "FormuleId,FormuleNom,DebutValidite,FinValidite,IsActive,Tarif,ActiviteId")] Formule formule)
        {
            ...
            ViewBag.ActiviteId = new SelectList(_applicationDbContext.Activites, "ActiviteId", "ActiviteNom", formule.ActiviteId);
            return View(formule);
        }
